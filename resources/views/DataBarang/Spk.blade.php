                  ...
                  <div class="modal-body">
                      ...
                      <div class="row mb-3">
                          <div class="col">
                              ...
                              <select class="form-select" id="pengemudi_id" name="pengemudi_id" required>
        ...
        <div class="card-body table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $spk->nomor_spk }}</td>
                        <td>{{ $spk->gudang->nama_gudang ?? 'N/A' }}</td>  <!-- Pastikan akses relasi dengan benar -->
                        <td>{{ $spk->pengemudi->nama ?? 'N/A' }}</td>
                        <td>{{ $spk->mekanik->nama ?? 'N/A' }}</td>
                        <td>{{ $spk->kodeRusak->kode_rusak ?? 'N/A' }}</td>
                        <td>{{ $spk->bagianGudang->nama ?? 'N/A' }}</td>
                        {{-- <td>
                            <a href="{{ route('spk.edit', $spk->id) }}" class="btn btn-sm btn-warning">Edit</a>
